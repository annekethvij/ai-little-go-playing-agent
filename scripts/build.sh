...
prefix="./$ASNLIB/"
ta_agent=("opponent_player") # 1 Opponent players: Input opponent player python file name here to play with your player.
surfix=".py"
...
for i in {0..0} # 1 Opponent players
do
    echo ""
